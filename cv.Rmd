...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _meganhmurray.com/cv/_")
} else {
...
The source code is available [on github.com/murraymegan/murray_megan_cv](https://github.com/murraymegan/murray_megan_cv).
